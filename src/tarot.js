const cardData = [
  {
    ...
    value: 1,
    meaning_up:
      "Habilidade, diplomacia, destreza, sutileza; doença, dor, perda, desastre, armadilhas de inimigos; autoconfiança, vontade.",
  ...
  },
  {
    ...
    name: "A Sacerdotisa",
    value: 2,
    meaning_up: "Segredos, mistério, o futuro ainda não revelado.",
    meaning_rev:
      "Paixão, ardor moral ou físico, vaidade, conhecimento superficial.",
  ...
  },
  {
    ...
    value: 3,
    meaning_up:
      "Fertilidade, iniciativa, longevidade; o desconhecido, clandestino; dificuldade, dúvida, ignorância.",
    meaning_rev:
      "Luz, verdade, a revelação de assuntos complexos, celebrações públicas; de acordo com outra interpretação, vacilação.",
  ...
  },
  {
    ...
    value: 4,
    meaning_up:
      "Estabilidade, poder, proteção, realização; uma pessoa importante; ajuda, razão, convicção; também autoridade e vontade.",
    meaning_rev:
      "Benevolência, compaixão, crédito; também confusão aos inimigos, obstrução, imaturidade.",
  ...
  },
  {
    ...
    value: 5,
    meaning_up:
      "Casamento, aliança, cativeiro, servidão; segundo outra interpretação, misericórdia e bondade; inspiração.",
    meaning_rev:
      "Sociedade, boa compreensão, concórdia, excesso de bondade, fraqueza.",
  ...
  },
  {
    ...
    meaning_rev:
      "Fracasso, planos tolos. Outra interpretação fala de casamento frustrado e contrariedades de todos os tipos.",
  ...
  },
  {
    ...
    value: 7,
    meaning_up:
      "Auxílio, providência, guerra, triunfo, presunção, vingança, problemas.",
  ...
  },
  {
    ...
    value: 8,
    meaning_up:
      "Poder, energia, ação, coragem, magnanimidade; também sucesso completo e honras.",
    meaning_rev:
      "Despotismo, abuso de poder, fraqueza, discórdia, às vezes até mesmo desgraça.",
  ...
  },
  {
    ...
    value: 9,
    meaning_up:
      "Prudência, circunspecção; também e especialmente traição, dissimulação, malandragem, corrupção.",
  ...
  },
  {
    ...
    value: 11,
    meaning_up:
      "Equidade, retidão, probidade, execução; triunfo do lado merecedor na lei.",
    meaning_rev:
      "Lei em todos os seus departamentos, complicações legais, intolerância, preconceito, severidade excessiva.",
  ...
  },
  {
    ...
    value: 12,
    meaning_up:
      "Sabedoria, circunspecção, discernimento, provações, sacrifício, intuição, adivinhação, profecia.",
  ...
  },
  {
    ...
    value: 13,
    meaning_up:
      "Fim, mortalidade, destruição, corrupção; também, para um homem, a perda de um benfeitor.",
    meaning_rev:
      "Inércia, sono, letargia, petrificação, sonambulismo; esperança destruída.",
  ...
  },
  {
    ...
    meaning_rev:
      "Coisas relacionadas a igrejas, religiões, seitas, o clero, às vezes até o padre que irá casar-se com o consulente; também desunião, combinações infelizes, interesses concorrentes.",
  ...
  },
  {
    ...
    value: 15,
    meaning_up:
      "Ravage, violência, veemência, esforços extraordinários, força, fatalidade; aquilo que é predestinado, mas não,  maléfico.",
  ...
  },
  {
    ...
    value: 16,
    meaning_up:
      "Miséria, angústia, indigência, adversidade, calamidade, desgraça, decepção, ruína.",
    meaning_rev:
      "De acordo com uma versão, o mesmo em menor grau, também opressão, aprisionamento, tirania.",
  ...
  },
  {
    ...
    value: 17,
    meaning_up:
      "Perda, roubo, privação, abandono; outra interpretação diz - esperança e perspectivas brilhantes.",
  ...
  },
  {
    ...
    value: 18,
    meaning_up:
      "Inimigos ocultos, perigo, calúnia, escuridão, terror, engano, forças ocultas, erro.",
    meaning_rev:
      "Instabilidade, inconstância, silêncio, graus menores de engano e erro.",
  ...
  },
  {
    ...
    value: 20,
    meaning_up:
      "Mudança de posição, renovação, resultado. Outra interpretação especifica de processo judicial.",
    meaning_rev:
      "Fraqueza, pusilanimidade, simplicidade; também deliberação, decisão, sentença.",
  ...
  },
  {
    ...
    value: 0,
    meaning_up:
      "Loucura, mania, extravagância, intoxicação, delírio, frenesi, revelação.",
    meaning_rev:
      "Negligência, ausência, dispersão, descuido, apatia, nulidade, vaidade.",
  ...
  },
  {
    ...
    value: 21,
    meaning_up:
      "Sucesso garantido, recompensa, viagem, rota, emigração, fuga, mudança de lugar.",
  ...
  },
  {
    ...
    type: "menor",
    meaning_up:
      "Jovem moreno, fiel, um amante, um enviado, um carteiro. Ao lado de um homem, ele dará testemunho favorável sobre ele. Um rival perigoso, se seguido pelo Pajem de Copas. Possui as principais qualidades do seu naipe. Pode significar inteligência familiar.",
    meaning_rev:
      "Anedotas, anúncios, más notícias. Também indecisão e a instabilidade que a acompanha.",
    desc: "Em uma cena semelhante à anterior, um jovem está em ato de proclamação. Ele é desconhecido, mas fiel, e suas notícias são estranhas.",
  ...
  },
  {
    ...
    type: "menor",
    meaning_up:
      "Partida, ausência, fuga, emigração. Um jovem moreno, amigável. Mudança de residência.",
    meaning_rev: "Ruptura, divisão, interrupção, discórdia.",
    desc: "Ele é mostrado como se estivesse em uma jornada, armado com uma vara curta e, embora com armadura, não está em uma missão belicosa. Ele está passando por montes ou pirâmides. O movimento do cavalo é chave para o caráter de seu cavaleiro e sugere um humor precipitado, ou coisas relacionadas a ele.",
  ...
  },
  {
    ...
    type: "menor",
    meaning_up:
      "Uma mulher morena, camponesa, amigável, casta, amorosa, honrada. Se a carta ao lado dela significa um homem, ela está bem disposta em relação a ele; se for uma mulher, ela está interessada no consulente. Também pode representar amor ao dinheiro ou certo sucesso nos negócios.",
    meaning_rev:
      "Boa, econômica, prestativa, útil. Também pode significar, dependendo da posição e das cartas ao redor, oposição, ciúme, até mesmo decepção e infidelidade.",
    desc: "Os paus ao longo deste naipe estão sempre em folhas, pois é um naipe de vida e animação. Emocionalmente e de outras formas, a personalidade da Rainha corresponde à do Rei, mas é mais magnética.",
  ...
  },
  {
    ...
    type: "menor",
    meaning_up:
      "Homem moreno, amigável, camponês, geralmente casado, honesto e consciente. A carta sempre significa honestidade e pode significar notícias sobre uma herança inesperada que virá em breve.",
    meaning_rev: "Bom, porém severo; austero, porém tolerante.",
    desc: "A natureza física e emocional atribuída a esta carta é escura, ardente, flexível, animada, apaixonada, nobre. O Rei ergue um bastão florido e usa, como suas três correspondências nos naipes restantes, o que é chamado de capuz de manutenção sob sua coroa. Ele se conecta com o símbolo do leão, que está estampado na parte de trás de seu trono.",
  ...
  },
  {
    ...
    type: "menor",
    meaning_up:
      "Criação, invenção, empreendimento, os poderes que resultam disso; princípio, começo, fonte; nascimento, família, origem e, em certo sentido, a virilidade que está por trás deles; o ponto de partida dos empreendimentos; de acordo com outra interpretação, dinheiro, fortuna, herança.",
    meaning_rev:
      "Queda, decadência, ruína, perdição, perecer, também uma certa alegria nublada.",
    desc: "Uma mão saindo de uma nuvem segura um bastão ou clava resistente.",
  ...
  },
  {
    ...
    type: "menor",
    meaning_up:
      "Entre as interpretações alternativas não é possível haver casamento; por um lado, riqueza, fortuna, magnificência; por outro, sofrimento físico, doença, desgosto, tristeza, mortificação. O desenho dá uma sugestão: aqui está um senhor olhando para o seu domínio e alternadamente contemplando um globo; isso lembra a doença, a mortificação, a tristeza de Alexandre em meio à grandiosidade das riquezas deste mundo.",
    meaning_rev: "Surpresa, encantamento, emoção, problema, medo.",
    desc: "Um homem alto olha de um telhado com ameias sobre o mar e a costa; ele segura um globo em sua mão direita, enquanto um bastão em sua mão esquerda repousa nas ameias; outro está fixado em um anel. A Rosa e a Cruz e o Lírio devem ser observados no lado esquerdo.",
  ...
  },
  {
    ...
    type: "menor",
    meaning_up:
      "Ele simboliza força estabelecida, empreendimento, esforço, comércio, descoberta; aqueles são seus navios, transportando suas mercadorias, que estão navegando sobre o mar. O cartão também significa cooperação habilidosa nos negócios, como se o príncipe mercador bem-sucedido estivesse olhando do seu lado para o seu com o objetivo de ajudá-lo.",
    meaning_rev:
      "O fim dos problemas, suspensão ou cessação da adversidade, trabalho árduo e decepção.",
    desc: "Uma personagem calma e imponente, de costas, olhando de um penhasco para os navios que passam sobre o mar. Três estacas estão plantadas no chão, e ele se apoia levemente em uma delas.",
  ...
  },
  {
    ...
    type: "menor",
    meaning_up:
      "Eles estão quase na superfície - vida rural, refúgio seguro, uma espécie de festa de colheita doméstica, repouso, concórdia, harmonia, prosperidade, paz e o trabalho aperfeiçoado dessas coisas.",
    meaning_rev:
      "O significado permanece inalterado; é prosperidade, aumento, felicidade, beleza, adorno.",
    desc: "A partir dos quatro grandes paus plantados em primeiro plano, há uma grande guirlanda suspensa; duas figuras femininas levantam buquês de flores; ao lado delas, há uma ponte sobre um fosso, que leva a uma antiga casa senhorial.",
  ...
  },
  {
    ...
    type: "menor",
    meaning_up:
      "Imitação, como por exemplo, luta simulada, mas também a competição e luta árdua na busca por riqueza e fortuna. Nesse sentido, está relacionado com a batalha da vida. Algumas atribuições dizem que é um carta de ouro, ganho, opulência.",
    meaning_rev: "Litígios, disputas, trapaças, contradição.",
    desc: "Um grupo de jovens brandindo bastões, como se estivessem em um jogo ou conflito. É uma guerra simulada, e para isso correspondem os",
  ...
  },
  {
    ...
    type: "menor",
    meaning_up:
      "A carta foi projetada de forma a abranger vários significados; superficialmente, é um vencedor triunfante, mas também representa grandes notícias, como aquelas que poderiam ser transportadas em estado pelo mensageiro do rei; é a expectativa coroada com o próprio desejo, a coroa da esperança, e assim por diante.",
    meaning_rev:
      "Apreensão, medo, como o de um inimigo vitorioso à porta; traição, deslealdade, como a abertura dos portões ao inimigo; também representa um atraso indefinido.",
    desc: "Um cavaleiro laureado segura um bastão adornado com uma coroa de louros; pedestres com bastões estão ao seu lado.",
  ...
  },
  {
    ...
    type: "menor",
    meaning_up:
      "É uma carta de coragem, pois, superficialmente, seis estão atacando um, que, no entanto, tem a posição vantajosa. No plano intelectual, significa discussão, contenda verbal; nos negócios - negociações, guerra comercial, trocas, competição. É também uma carta de sucesso, pois o combatente está no topo e seus inimigos podem ser incapazes de alcançá-lo.",
    meaning_rev:
      "Perplexidade, embaraços, ansiedade. Também é um aviso contra a indecisão.",
    desc: "Um jovem eminente em um penhasco brandindo um bastão; outros seis bastões são levantados em sua direção de baixo.",
  ...
  },
  {
    ...
    type: "menor",
    meaning_up:
      "Atividade em empreendimentos, o caminho dessa atividade, rapidez, como a de um mensageiro expresso; grande pressa, grande esperança, velocidade em direção a um fim que promete felicidade garantida; geralmente, aquilo que está em movimento; também as flechas do amor.",
    meaning_rev:
      "Flechas de ciúme, disputas internas, picadas de consciência, brigas; e disputas domésticas para pessoas casadas.",
    desc: "A carta representa movimento através do imóvel - um voo de bastões por um campo aberto; mas eles se aproximam do fim de seu percurso. Aquilo que eles significam está próximo; pode até estar no limiar.",
  ...
  },
  {
    ...
    type: "menor",
    meaning_up:
      "A carta significa força na oposição. Se atacado, a pessoa enfrentará um ataque com coragem; e sua estrutura mostra que ele pode ser um adversário formidável. Com esse significado principal, há todos os seus possíveis adjuntos - atraso, suspensão, adiamento.",
    meaning_rev: "Obstáculos, adversidade, calamidade.",
    desc: "A figura apoia-se em seu bastão e tem um olhar expectante, como se estivesse aguardando um inimigo. Atrás estão outros oito bastões - eretos, em disposição ordenada, como uma palisada.",
  ...
  },
  {
    ...
    type: "menor",
    meaning_up:
      "Uma carta de muitos significados, e algumas das interpretações não podem ser harmonizadas. Deixo de lado aquilo que a conecta com honra e boa fé. O significado principal é simplesmente opressão, mas também pode representar fortuna, ganho, qualquer tipo de sucesso, e então é a opressão dessas coisas. É também uma carta de falsa aparência, disfarce, perfídia. O lugar para o qual a figura está se aproximando pode sofrer com as varas que ele carrega. O sucesso é anulado se a Nove de Espadas seguir, e se for uma questão de um processo judicial, haverá certa perda.",
    meaning_rev: "Contrariedades, dificuldades, intrigas e suas analogias.",
    desc: "Um homem oprimido pelo peso das dez varas que ele está carregando.",
  ...
  },
  {
    ...
    type: "menor",
    meaning_up:
      "Jovem justo, impelido a prestar serviço e com quem o consulente estará conectado; um jovem estudioso; notícias, mensagem; aplicação, reflexão, meditação; também coisas direcionadas aos negócios.",
    meaning_rev: "Gosto, inclinação, apego, sedução, decepção, artifício.",
    desc: "Um pajem justo, agradável, com um aspecto um tanto efeminado, de olhar estudioso e intenso, contempla um peixe subindo de uma taça para olhá-lo. São as imagens da mente tomando forma.",
  ...
  },
  {
    ...
    type: "menor",
    meaning_up:
      "Chegada, abordagem - às vezes a de um mensageiro; avanços, proposta, comportamento, convite, incitação.",
    meaning_rev: "Trapaça, artifício, sutileza, trapaça, duplicidade, fraude.",
    desc: "Elegante, mas não guerreiro; cavalgando silenciosamente, usando um capacete alado, referindo-se às graças superiores da imaginação que às vezes caracterizam esta carta. Ele também é um sonhador, mas as imagens do lado do sentido o assombram em sua visão.",
  ...
  },
  {
    ...
    type: "menor",
    meaning_up:
      "Mulher boa, justa; mulher honesta e dedicada, que prestará serviço ao consulente; inteligência amorosa e, portanto, o dom da visão; sucesso, felicidade, prazer; também sabedoria, virtude; uma cônjuge perfeita e uma boa mãe.",
    meaning_rev:
      "As interpretações variam; mulher boa; caso contrário, mulher distinta, mas não confiável; mulher perversa; vício, desonra, depravação.",
    desc: "Bonita, justa, sonhadora - como alguém que vê visões em uma taça. Essa é, no entanto, apenas uma de suas facetas; ela vê, mas também age, e sua atividade alimenta seu sonho.",
  ...
  },
  {
    ...
    type: "menor",
    meaning_up:
      "Homem justo, homem de negócios, direito ou divindade; responsável, disposto a ajudar o consulente; também equidade, arte e ciência, incluindo aqueles que professam ciência, direito e arte; inteligência criativa.",
    meaning_rev:
      "Homem desonesto, trapaceiro; engano, extorsão, injustiça, vício, escândalo, saque, perda considerável.",
    desc: "Ele segura um cetro curto em sua mão esquerda e uma grande taça em sua mão direita; seu trono está situado sobre o mar; de um lado, um navio está navegando e, do outro, um golfinho está saltando. O implícito é que o Sinal da Taça naturalmente se refere à água, que aparece em todas as cartas da corte.",
  ...
  },
  {
    ...
    type: "menor",
    meaning_up:
      "Casa do coração verdadeiro, alegria, contentamento, moradia, nutrição, abundância, fertilidade; Mesa Sagrada, felicidade nisso.",
    meaning_rev: "Casa do coração falso, mutação, instabilidade, revolução.",
    desc: "As águas estão abaixo, e sobre elas estão lírios d'água; a mão emerge da nuvem, segurando na palma a taça, da qual quatro correntes estão fluindo; uma pomba, carregando em seu bico uma Hóstia marcada com uma cruz, desce para colocar a Hóstia na Taça; o orvalho da água está caindo por todos os lados. É uma sugestão daquilo que pode estar por trás dos Arcanos Menores.",
  ...
  },
  {
    ...
    type: "menor",
    meaning_up:
      "Amor, paixão, amizade, afinidade, união, concórdia, simpatia, a inter-relação dos sexos e - como uma sugestão à parte de todas as práticas de adivinhação - aquele desejo que não está na Natureza, mas pelo qual a Natureza é santificada.",
    meaning_rev:
      "Lascívia, cobiça, ciúme, desejo, anseio, mas o cartão também pode fornecer, diz W., aquele desejo que não está na natureza, mas pelo qual a natureza é santificada.",
    desc: "Um jovem e uma jovem estão se comprometendo um com o outro, e acima de suas taças, ergue-se o Caduceu de Hermes, entre as grandes asas das quais aparece a cabeça de um leão. É uma variante de um símbolo que é encontrado em alguns antigos exemplos desta carta. Alguns significados emblemáticos curiosos estão associados a ele, mas eles não nos dizem respeito neste lugar.",
  ...
  },
  {
    ...
    type: "menor",
    meaning_up:
      "A conclusão de qualquer assunto em abundância, perfeição e alegria; desfecho feliz, vitória, realização, consolo, cura.",
    meaning_rev:
      "Expedição, prontidão, conquista, fim. Também significa o lado do excesso no prazer físico e os prazeres dos sentidos.",
    desc: "Donzelas em um jardim com as taças erguidas, como se estivessem fazendo um brinde uma à outra.",
  ...
  },
  {
    ...
    type: "menor",
    meaning_up:
      "Cansaço, desgosto, aversão, vexações imaginárias, como se o vinho deste mundo tivesse causado apenas saciedade; outro vinho, como um presente de fada, é agora oferecido ao dissipador, mas ele não encontra consolo nele. Este também é um cartão de prazer misturado.",
    meaning_rev: "Novidade, presságio, nova instrução, novas relações.",
    desc: "Um jovem está sentado debaixo de uma árvore e contempla três copas colocadas na grama diante dele; um braço que sai de uma nuvem lhe oferece outra taça. Sua expressão, no entanto, é de descontentamento com seu ambiente.",
  ...
  },
  {
    ...
    type: "menor",
    meaning_up:
      "Uma figura escura e encapuzada, olhando para o lado para três copas caídas, enquanto outras duas permanecem em pé atrás dele; há uma ponte ao fundo, levando a uma pequena fortaleza ou propriedade. Significados Adivinhatórios: É um cartão de perda, mas algo ainda resta; três foram tomadas, mas duas foram deixadas; é um cartão de herança, patrimônio, transmissão, mas não correspondendo às expectativas; para alguns intérpretes, é um cartão de casamento, mas não sem amargura ou frustração.",
    meaning_rev:
      "Notícias, alianças, afinidade, consanguinidade, ancestralidade, retorno, projetos falsos.",
    desc: "Uma figura escura e encapuzada, olhando para o lado para três copas caídas, enquanto outras duas permanecem em pé atrás dele; há uma ponte ao fundo, levando a uma pequena fortaleza ou propriedade. Significados Adivinhatórios: É um cartão de perda, mas algo ainda resta; três foram tomadas, mas duas foram deixadas; é um cartão de herança, patrimônio, transmissão, mas não correspondendo às expectativas; para alguns intérpretes, é um cartão de casamento, mas não sem amargura ou frustração. Invertido: Notícias, alianças, afinidade, consanguinidade, ancestralidade, retorno, projetos falsos.",
  ...
  },
  {
    ...
    type: "menor",
    meaning_up:
      "Um cartão do passado e das memórias, olhando para trás, como, por exemplo, na infância; felicidade, prazer, mas provenientes principalmente do passado; coisas que desapareceram. Outra interpretação inverte isso, fornecendo novas relações, novos conhecimentos, novo ambiente e, então, as crianças se divertem em um local desconhecido.",
    meaning_rev: "O futuro, renovação, o que acontecerá em breve.",
    desc: "Crianças em um antigo jardim, com suas xícaras cheias de flores.",
  ...
  },
  {
    ...
    type: "menor",
    meaning_up:
      "Favores das fadas, imagens de reflexão, sentimento, imaginação, coisas vistas no espelho da contemplação; algum grau de realização nessas áreas, mas nada permanente ou substancial é sugerido.",
    meaning_rev: "Desejo, vontade, determinação, projeto.",
    desc: "Estranhas taças de visão, mas as imagens são especialmente aquelas do espírito fantástico.",
  ...
  },
  {
    ...
    type: "menor",
    meaning_up:
      "O próprio significado do cartão é evidente à primeira vista, mas outras interpretações são completamente antitéticas - trazendo alegria, suavidade, timidez, honra, modéstia. Na prática, geralmente é encontrado que o cartão mostra o declínio de um assunto, ou que um assunto que se pensava ser importante é realmente de pouca consequência - tanto para o bem quanto para o mal.",
    meaning_rev: "Grande alegria, felicidade, festa.",
    desc: "Um homem de aspecto abatido está abandonando os cálices de sua felicidade, empreendimento, empreendimento ou preocupação anterior.",
  ...
  },
  {
    ...
    type: "menor",
    meaning_up:
      "Concordância, satisfação física; também vitória, sucesso, vantagem; satisfação para o consulente ou pessoa para quem a consulta é feita.",
    meaning_rev:
      "Verdade, lealdade, liberdade; mas as interpretações variam e incluem erros, imperfeições, etc.",
    desc: "Uma figura nobre festou ao seu contento, e uma abundante oferta de vinho está no balcão arqueado atrás dele, parecendo indicar que o futuro também está assegurado. A imagem oferece apenas o aspecto material, mas há outros aspectos.",
  ...
  },
  {
    ...
    type: "menor",
    meaning_up:
      "Contentamento, repouso do coração inteiro; a perfeição desse estado; também a perfeição do amor humano e da amizade; se acompanhado por vários arcanos maiores, uma pessoa que está cuidando dos interesses do consulente; também a cidade, vila ou país habitado pelo consulente.",
    meaning_rev: "Repouso do coração falso, indignação, violência.",
    desc: "Aparecimento de Copas em um arco-íris; é contemplado com admiração e êxtase por um homem e uma mulher abaixo, evidentemente marido e esposa. Seu braço direito está ao redor dela; seu braço esquerdo está levantado; ela levanta o braço direito. As duas crianças dançando perto deles não observaram o prodígio, mas estão felizes à sua maneira. Há uma cena de lar além.",
  ...
  },
  {
    ...
    type: "menor",
    meaning_up:
      "Aplicação, estudo, bolsa de estudos, reflexão; outra interpretação diz notícias, mensagens e aquele que as traz; também governar, administração.",
    meaning_rev:
      "Prodigalidade, dissipação, liberalidade, luxo; notícias desfavoráveis.",
    desc: "Uma figura jovem, olhando atentamente para o pentáculo que paira sobre suas mãos erguidas. Ele se move lentamente, insensível ao que o rodeia.",
  ...
  },
  {
    ...
    type: "menor",
    meaning_up:
      "Utilidade, utilidade, interesse, responsabilidade, retidão - tudo no plano normal e externo.",
    meaning_rev:
      "Inércia, ociosidade, repouso desse tipo, estagnação; também placidez, desânimo, descuido.",
    desc: "Ele monta um cavalo lento, duradouro e pesado, que corresponde à sua própria aparência. Ele exibe seu símbolo, mas não olha para ele.",
  ...
  },
  {
    ...
    suit: "ouros",
    type: "menor",
    meaning_up: "Opulência, generosidade, magnificência, segurança, liberdade.",
    meaning_rev: "Mal, suspeita, suspense, medo, desconfiança.",
    desc: "O rosto sugere o de uma mulher morena, cujas qualidades podem ser resumidas na ideia de grandeza de espírito; ela também possui uma expressão séria de inteligência; ela contempla seu símbolo e pode ver mundos dentro dele.",
  ...
  },
  {
    ...
    type: "menor",
    meaning_up:
      "Valor, inteligência realizadora, negócios e aptidão intelectual normal, às vezes dons matemáticos e realizações desse tipo; sucesso nesses caminhos.",
    meaning_rev: "Vício, fraqueza, feiura, perversidade, corrupção, perigo.",
    desc: "A figura não requer uma descrição especial. O rosto é bastante escuro, sugerindo coragem, mas com uma tendência um tanto letárgica. A cabeça do touro deve ser observada como um símbolo recorrente no trono. O sinal deste naipe é representado ao longo como gravado ou blasonado com o pentagrama, simbolizando a correspondência dos quatro elementos na natureza humana e por meio dos quais podem ser governados. Em muitos baralhos antigos de Tarô, este naipe representava moedas correntes, dinheiro, deniers. Não inventei a substituição de pentáculos e não tenho nenhuma causa especial para sustentar em relação à alternativa. Mas o consenso dos significados divinatórios aponta para alguma mudança, porque as cartas não tratam especialmente de questões financeiras.",
  ...
  },
  {
    ...
    type: "menor",
    meaning_up:
      "Perfeita satisfação, felicidade, êxtase; também inteligência rápida; ouro.",
    meaning_rev:
      "O lado negativo da riqueza, má inteligência; também grandes riquezas. Em qualquer caso, mostra prosperidade, condições materiais confortáveis, mas se isso é vantajoso para o possuidor dependerá se a carta está invertida ou não.",
    desc: "Uma mão - como de costume, saindo de uma nuvem - segura um pentáculo.",
  ...
  },
  {
    ...
    type: "menor",
    meaning_up:
      "Por um lado, é representado como um cartão de alegria, recreação e suas conexões, que é o tema do design; mas também pode ser interpretado como notícias e mensagens por escrito, obstáculos, agitação, problemas, envolvimento.",
    meaning_rev:
      " Alegria forçada, prazer simulado, sentido literal, escrita, composição, letras de câmbio.",
    desc: "Um jovem, em pleno ato de dançar, segura um pentáculo em cada mão, e eles estão unidos por uma corda infinita que se assemelha ao número 8 invertido.",
  ...
  },
  {
    ...
    type: "menor",
    meaning_up:
      "Ofício, comércio, trabalho especializado; geralmente, no entanto, é considerado como um cartão de nobreza, aristocracia, renome, glória.",
    meaning_rev:
      "Mediocridade no trabalho e em outros aspectos, puerilidade, mesquinhez, fraqueza.",
    desc: "Um escultor em seu trabalho em um mosteiro. Compare com o desenho que ilustra o Oito de Ouros. O aprendiz ou amador nele recebeu sua recompensa e agora está trabalhando com seriedade.",
  ...
  },
  {
    ...
    type: "menor",
    meaning_up:
      "A segurança das posses, apegar-se ao que se tem, presente, legado, herança.",
    meaning_rev: "Suspense, atraso, oposição.",
    desc: "Uma figura coroada, tendo um pentáculo sobre sua coroa, segura outro com as mãos e braços; dois pentáculos estão sob seus pés. Ele se apega ao que possui.",
  ...
  },
  {
    ...
    type: "menor",
    meaning_up:
      "O cartão pressagia problemas materiais acima de tudo, seja na forma ilustrada - ou seja, a privação - ou de outra forma. Para alguns cartomantes, é um cartão de amor e amantes - esposa, marido, amigo, amante; também concordância, afinidades. Essas alternativas não podem ser harmonizadas.",
    meaning_rev: "Desordem, caos, ruína, discórdia, dissipação.",
    desc: "Dois mendigos em uma tempestade de neve passam por uma janela iluminada.",
  ...
  },
  {
    ...
    type: "menor",
    meaning_up:
      "Presentes, presentes, gratificação. Outra interpretação diz atenção, vigilância, agora é o momento aceito, prosperidade presente, etc.",
    meaning_rev: "Desejo, cobiça, inveja, ciúme, ilusão.",
    desc: "Uma pessoa, disfarçada de comerciante, pesa dinheiro em uma balança e o distribui para os necessitados e aflitos. É um testemunho de seu próprio sucesso na vida, bem como de sua bondade de coração.",
  ...
  },
  {
    ...
    type: "menor",
    meaning_up:
      "Esses significados são extremamente contraditórios; em geral, é um cartão de dinheiro, negócios, trocas; mas uma leitura dá discussão, brigas - e outra, inocência, engenhosidade, purificação.",
    meaning_rev:
      "Motivo de ansiedade em relação ao dinheiro que pode ser proposto emprestar.",
    desc: "Um jovem, apoiado em seu bastão, olha atentamente para sete pentáculos presos a um aglomerado de vegetação à sua direita; dir-se-ia que esses são seus tesouros e que seu coração está lá.",
  ...
  },
  {
    ...
    type: "menor",
    meaning_up:
      "Trabalho, emprego, comissão, habilidade artesanal, habilidade em ofícios e negócios, talvez na fase preparatória.",
    meaning_rev:
      "Ambição vazia, vaidade, cobiça, exigência, usura. Também pode significar a posse de habilidade, no sentido de uma mente engenhosa voltada para a astúcia e intriga.",
    desc: "Um artista em pedra em seu trabalho, que ele exibe na forma de troféus.",
  ...
  },
  {
    ...
    type: "menor",
    meaning_up:
      "Prudência, segurança, sucesso, realização, certeza, discernimento.",
    meaning_rev: "Astúcia, engano, projeto frustrado, má fé.",
    desc: "Uma mulher, com um pássaro no pulso, está no meio de uma grande abundância de videiras no jardim de uma casa senhorial. É uma ampla propriedade, sugerindo abundância em todas as coisas. Possivelmente é sua própria posse e testemunha o bem-estar material.",
  ...
  },
  {
    ...
    type: "menor",
    meaning_up:
      "Lucro, riquezas; assuntos familiares, arquivos, origem, o lar de uma família.",
    meaning_rev:
      "Acaso, fatalidade, perda, roubo, jogos de azar; às vezes, presente, dote, pensão.",
    desc: "Um homem e uma mulher debaixo de um arco que dá entrada a uma casa e propriedade. Eles são acompanhados por uma criança, que olha curiosamente para dois cachorros abordando uma pessoa idosa sentada em primeiro plano. A mão da criança está em um deles.",
  ...
  },
  {
    ...
    type: "menor",
    meaning_up:
      "Autoridade, supervisão, serviço secreto, vigilância, espionagem, exame e as qualidades a elas relacionadas.",
    meaning_rev:
      "Lado mais negativo dessas qualidades; o que é imprevisto, estado despreparado; também é insinuada doença.",
    desc: "Uma figura ágil e ativa segura uma espada erguida em ambas as mãos, enquanto caminha rapidamente. Ele está passando por um terreno acidentado, e ao seu redor as nuvens estão colocadas de forma selvagem. Ele está alerta e ágil, olhando para todos os lados, como se um inimigo esperado pudesse aparecer a qualquer momento.",
  ...
  },
  {
    ...
    type: "menor",
    meaning_up:
      "Habilidade, coragem, capacidade, defesa, habilidade, inimizade, ira, guerra, destruição, oposição, resistência, ruína. Portanto, há um sentido em que o cartão significa morte, mas carrega esse significado apenas em sua proximidade com outros cartões de fatalidade.",
    meaning_rev: "Imprudência, incapacidade, extravagância.",
    desc: "Ele está cavalgando em plena velocidade, como se estivesse dispersando seus inimigos. No desenho, ele é realmente um herói prototípico da cavalaria romântica. Ele poderia ser quase Galahad, cuja espada é rápida e certeira porque ele é puro de coração.",
...

  {
    ...
    type: "menor",
    meaning_up:
      "Viuvice, tristeza e constrangimento feminino, ausência, esterilidade, luto, privação, separação.",
    meaning_rev:
      "Malícia, fanatismo, artifício, prudência exagerada, aflição, engano.",
    desc: "Sua mão direita ergue a arma verticalmente e a empunhadura repousa em um braço de sua cadeira real. A mão esquerda está estendida, o braço levantado, sua expressão é severa, mas moderada; sugere familiaridade com a tristeza. Não representa misericórdia e, apesar de sua espada, ela dificilmente é um símbolo de poder.",
  ...
  },
  {
    ...
    type: "menor",
    meaning_up:
      "Triunfo, o grau excessivo em tudo, conquista, triunfo da força. É um cartão de grande poder, tanto no amor quanto no ódio. A coroa pode ter um significado muito mais elevado do que normalmente está dentro do âmbito da leitura de tarô.",
    meaning_rev:
      "O mesmo, mas os resultados são desastrosos; outra interpretação diz: concepção, parto, aumento, multiplicidade.",
    desc: "Uma mão emerge de uma nuvem, segurando uma espada, cuja ponta está circundada por uma coroa.",
  ...
  },
  {
    ...
    type: "menor",
    meaning_up:
      "Conformidade e o equilíbrio que isso sugere, coragem, amizade, concórdia em um estado de conflito; outra leitura sugere ternura, afeto, intimidade. A sugestão de harmonia e outras interpretações favoráveis devem ser consideradas de maneira qualificada, pois as Espadas geralmente não são simbólicas de forças benéficas nos assuntos humanos.",
    meaning_rev: "Impostura, falsidade, duplicidade, deslealdade.",
    desc: "Uma figura feminina vendada equilibra duas espadas sobre seus ombros.",
  ...
  },
  {
    ...
    type: "menor",
    meaning_up:
      "Remoção, ausência, atraso, divisão, ruptura, dispersão, e tudo o que o desenho naturalmente significa, sendo muito simples e óbvio para exigir uma enumeração específica.",
    meaning_rev:
      "Alienação mental, erro, perda, distração, desordem, confusão.",
    desc: "Três espadas perfurando um coração; nuvem e chuva ao fundo.",
  ...
  },
  {
    ...
    type: "menor",
    meaning_up:
      "Vigilância, retiro, solidão, repouso do eremita, exílio, túmulo e caixão. São esses últimos que sugeriram o desenho.",
    meaning_rev:
      "Administração sábia, circunspecção, economia, avareza, precaução, testamento.",
    desc: "A efígie de um cavaleiro na atitude de oração, deitado em seu túmulo.",
  ...
  },
  {
    ...
    type: "menor",
    meaning_up:
      "Degradação, destruição, revogação, infâmia, desonra, perda, com as variantes e analogias desses significados.",
    meaning_rev: "O mesmo; enterro e cerimônias fúnebres.",
    desc: "Um homem desdenhoso observa duas figuras recuando e abatidas. Suas espadas estão caídas no chão. Ele carrega outras duas em seu ombro esquerdo, e uma terceira espada está em sua mão direita, com a ponta voltada para a terra. Ele é o mestre em posse do campo.",
  ...
  },
  {
    ...
    type: "menor",
    meaning_up:
      "Viagem por água, rota, caminho, enviado, comissário, expediente.",
    meaning_rev:
      "Declaração, confissão, publicidade; uma interpretação diz que é uma proposta de amor.",
    desc: "Um barqueiro transportando passageiros em seu barco para a margem oposta. O trajeto é suave, e considerando que a carga é leve, pode-se notar que o trabalho não está além de sua força.",
  ...
  },
  {
    ...
    type: "menor",
    meaning_up:
      "Desenho, tentativa, desejo, esperança, confiança; também brigas, um plano que pode falhar, aborrecimento. O significado é incerto em sua importância, pois os significados estão amplamente divergentes entre si.",
    meaning_rev: "Bom conselho, instrução, difamação, tagarelice.",
    desc: "Um homem carregando rapidamente cinco espadas; as outras duas espadas do naipe permanecem presas no chão. Um acampamento está próximo.",
  ...
  },
  {
    ...
    type: "menor",
    meaning_up:
      "Más notícias, pesar violento, crise, censura, poder restrito, conflito, calúnia; também doença.",
    meaning_rev:
      "Inquietação, dificuldade, oposição, acidente, traição; o inesperado; fatalidade.",
    desc: "Uma mulher amarrada e vendada, com as espadas do naipe ao seu redor. No entanto, é mais uma carta de confinamento temporário do que de aprisionamento irreversível.",
  ...
  },
  {
    ...
    suit: "espadas",
    type: "menor",
    meaning_up: "Morte, fracasso, aborto, atraso, decepção, desespero.",
    meaning_rev: "Prisão, suspeita, dúvida, medo razoável, vergonha.",
    desc: "Uma pessoa sentada em seu leito em lamento, com as espadas sobre ela. Ela é como alguém que não conhece tristeza semelhante à dela. É uma carta de desolação absoluta.",
  ...
  },
  {
    ...
    type: "menor",
    meaning_up:
      "Tudo o que é indicado pelo desenho; também dor, aflição, lágrimas, tristeza, desolação. Não é especialmente uma carta de morte violenta.",
    meaning_rev:
      "Vantagem, lucro, sucesso, favor, mas nada disso é permanente; também poder e autoridade.",
    desc: "Uma figura prostrada, perfurada por todas as espadas que pertencem à carta.",
